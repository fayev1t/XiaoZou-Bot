...
- Source the id from the timeline: `<message sender_id="USER_ID">` exposes the sender's id, and inline `<at user="USER_ID"/>` segments also expose ids.
